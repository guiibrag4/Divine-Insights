  ...
  return (
    <section className="mt-12 md:mt-16 mb-12">
      ...
      <Link
        ...
        className="theme-card group block rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow border border-neutral-200 dark:border-slate-700 bg-white dark:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600"
      >
