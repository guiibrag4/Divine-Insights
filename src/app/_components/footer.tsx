...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-stone-50 to-stone-100 dark:from-slate-900 dark:to-slate-800 border-t border-stone-200 dark:border-slate-700">
      <Container>
        <div className="py-12 md:py-16">
          ...
          <div className="flex items-center justify-center gap-6 mb-8">
            ...
            <a
              ...
              className="group flex items-center justify-center w-12 h-12 rounded-full bg-white dark:bg-slate-700 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110"
            ...
            <a
              ...
              aria-label="GitHub"
            >
              <svg className="w-6 h-6 text-stone-800 dark:text-stone-200 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
